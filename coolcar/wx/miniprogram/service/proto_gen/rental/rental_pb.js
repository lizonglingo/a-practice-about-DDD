...
export const rental = $root.rental = (() => {
    ...
    rental.v1 = (function() {
        ...
        v1.Identity = (function() {
             ...
             * @property {number|null} [brithDateMillis] Identity brithDateMillis
             */
            ...
            /**
             * Identity brithDateMillis.
             * @member {number} brithDateMillis
             * @memberof rental.v1.Identity
             * @instance
             */
            Identity.prototype.brithDateMillis = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
            ...
            Identity.fromObject = function fromObject(object) {
                ...
                if (object.brithDateMillis != null)
                    if ($util.Long)
                        (message.brithDateMillis = $util.Long.fromValue(object.brithDateMillis)).unsigned = false;
                    else if (typeof object.brithDateMillis === "string")
                        message.brithDateMillis = parseInt(object.brithDateMillis, 10);
                    else if (typeof object.brithDateMillis === "number")
                        message.brithDateMillis = object.brithDateMillis;
                    else if (typeof object.brithDateMillis === "object")
                        message.brithDateMillis = new $util.LongBits(object.brithDateMillis.low >>> 0, object.brithDateMillis.high >>> 0).toNumber();
                return message;
            };
            ...
            Identity.toObject = function toObject(message, options) {
                ...
                if (options.defaults) {
                    ...
                    if ($util.Long) {
                        let long = new $util.Long(0, 0, false);
                        object.brithDateMillis = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                    } else
                        object.brithDateMillis = options.longs === String ? "0" : 0;
                }
                ...
                if (message.brithDateMillis != null && message.hasOwnProperty("brithDateMillis"))
                    if (typeof message.brithDateMillis === "number")
                        object.brithDateMillis = options.longs === String ? String(message.brithDateMillis) : message.brithDateMillis;
                    else
                        object.brithDateMillis = options.longs === String ? $util.Long.prototype.toString.call(message.brithDateMillis) : options.longs === Number ? new $util.LongBits(message.brithDateMillis.low >>> 0, message.brithDateMillis.high >>> 0).toNumber() : message.brithDateMillis;
                return object;
            };
        ...
        v1.GetProfileResponse = (function() {
             ...
             * @constructor
             * @param {rental.v1.IGetProfileResponse=} [properties] Properties to set
             */
             ...
             * @function fromObject
             * @memberof rental.v1.GetProfileResponse
             * @static
             * @param {Object.<string,*>} object Plain object
             * @returns {rental.v1.GetProfileResponse} GetProfileResponse
             */
            GetProfileResponse.fromObject = function fromObject(object) {
                if (object instanceof $root.rental.v1.GetProfileResponse)
                    return object;
                return new $root.rental.v1.GetProfileResponse();
            };
             ...
             * @memberof rental.v1.GetProfileResponse
             * @static
             * @param {rental.v1.GetProfileResponse} message GetProfileResponse
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
            GetProfileResponse.toObject = function toObject() {
                return {};
            };
