...
type CarServiceClient interface {
	...
	GetCats(ctx context.Context, in *GetCarsRequest, opts ...grpc.CallOption) (*GetCarsResponse, error)
...
func (c *carServiceClient) GetCats(ctx context.Context, in *GetCarsRequest, opts ...grpc.CallOption) (*GetCarsResponse, error) {
	out := new(GetCarsResponse)
	err := c.cc.Invoke(ctx, "/car.v1.CarService/GetCats", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CarServiceServer interface {
	...
	GetCats(context.Context, *GetCarsRequest) (*GetCarsResponse, error)
...
func (UnimplementedCarServiceServer) GetCats(context.Context, *GetCarsRequest) (*GetCarsResponse, error) {
...
func _CarService_GetCats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCarsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CarServiceServer).GetCats(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/car.v1.CarService/GetCats",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CarServiceServer).GetCats(ctx, req.(*GetCarsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CarService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetCats",
			Handler:    _CarService_GetCats_Handler,
		},
		{
			MethodName: "LockCar",
